  ...
  return (
    <div id="about2">
      ...
      <div className="aboutbody">
        ...
        <div className="paragraph">
          <h2 className="myName">
            <span className="my">My Name Is</span>
            <span className="ademola"> Omikunle Ademola</span>
          </h2>

          <p className="parabody">
            I am passionate about creating responsive, user-friendly
            websites that are both visually appealing and functional.
            No matter what the scope of the project is, I am committed
            to building high-quality websites that meet the needs of my
      ...
      <div className="candidates-embed">
        <iframe
          src="http://localhost:5173/?slug=maryam-technologies-limited&theme=%23395A7F"
